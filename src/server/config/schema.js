...
module.exports = function () {
  return _joi2['default'].object({
    // REX
    laas: _joi2['default'].object({
        cf_uaa_url: _joi2['default'].any()['default']({}),
        cf_api_url: _joi2['default'].any()['default']({}),
        cf_uaa_callback_url: _joi2['default'].any()['default']({}),
        cf_uaa_scope: _joi2['default'].any()['default']({}),
        cf_client_id: _joi2['default'].any()['default']({}),
        cf_client_secret: _joi2['default'].any()['default']({}),
        elasticsearch_index_prefix: _joi2['default'].any()['default']({})
    })['default'](),
    ...
    server: _joi2['default'].object({
      ...
      defaultRoute: _joi2['default'].string()['default']('/app/laas').regex(/^\//, 'start with a slash'),
    ...
    optimize: _joi2['default'].object({
      ...
      // useBundleCache: _joi2['default'].boolean()['default'](false),
